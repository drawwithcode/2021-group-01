...
(function (root, factory) {
  ...
  var SuperGif = function (opts) {
    ...
    var setSizes = function (w, h) {
      ...
      tmpCanvas.width = screen.width;
      tmpCanvas.height = screen.height;
      tmpCanvas.style.width = screen.width;
      tmpCanvas.style.height = screen.height;
    ...
    var init = function () {
      ...
      toolbar.style.minWidth = screen.width;
